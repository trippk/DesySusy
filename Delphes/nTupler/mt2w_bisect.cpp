...
//dk
void mt2w::set_momenta(const TLorentzVector& pl,  const TLorentzVector& pb1, 
                       const TLorentzVector& pb2, double pmissx, double pmissy)
{
   ...
   set_momenta(pl.E(),pl.Px(),pl.Py(),pl.Pz(),
               pb1.E(),pb1.Px(),pb1.Py(),pb1.Pz(),
               pb2.E(),pb2.Px(),pb2.Py(),pb2.Pz(),
               pmissx,pmissy);
}
