...
//dk#define RELATIVE_PRECISION 0.00001 //defined as precision = RELATIVE_PRECISION * scale, where scale = max{Ea, Eb}
#define RELATIVE_PRECISION 0.0001 //defined as precision = RELATIVE_PRECISION * scale, where scale = max{Ea, Eb}
...
{  
   public:
      ...
      void   set_momenta(const TLorentzVector& pl0, const TLorentzVector& pb10, const TLorentzVector& pb20, double pmissx, double pmissy);  //b1 pairs with l
