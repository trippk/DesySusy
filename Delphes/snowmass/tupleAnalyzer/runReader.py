...
# by historic reason we have as dir names: bjets  diboson  tdr tdrNew tjets  ttbar
...
#
# NoPU
inDir['NoPU']['TDR4'] = base+'/NoPU/tdrNew/4/'
inDir['NoPU']['TDR5'] = base+'/NoPU/tdrNew/5/'
inDir['NoPU']['TDR6'] = base+'/NoPU/tdrNew/6/'
inDir['NoPU']['TDR8'] = base+'/NoPU/tdrNew/8/'
# 50PU
inDir['50PU']['TDR4'] = base+'/50PU/tdrNew/4/'
inDir['50PU']['TDR5'] = base+'/50PU/tdrNew/5/'
inDir['50PU']['TDR6'] = base+'/50PU/tdrNew/6/'
inDir['50PU']['TDR8'] = base+'/50PU/tdrNew/8/'
# 140PU
inDir['140PU']['TDR4'] = base+'/140PU/tdrNew/4/'
inDir['140PU']['TDR5'] = base+'/140PU/tdrNew/5/'
inDir['140PU']['TDR6'] = base+'/140PU/tdrNew/6/'
inDir['140PU']['TDR8'] = base+'/140PU/tdrNew/8/'
