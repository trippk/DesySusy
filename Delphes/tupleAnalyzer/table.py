...
# here we print <<<<<<<<<<<<<<<<<<<<<<<<
aTable('SingleS','PhaseI_C0_NoPU', 0.25,0.15,2)
print '-----------------------------------------------------------------------------'
aTable('SingleS','PhaseI_C0_140PU', 0.25,0.15,2)
print '-----------------------------------------------------------------------------'
aTable('SingleS','PhaseII_C3_140PU',0.25,0.15,2)
print '-----------------------------------------------------------------------------'
aTable('SingleS','PhaseII_C4_140PU',0.25,0.15,2)
