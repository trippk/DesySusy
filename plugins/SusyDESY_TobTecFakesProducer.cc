...
class SusyDESY_TobTecFakesProducer : public edm::EDProducer {
   public:
      explicit SusyDESY_TobTecFakesProducer(const edm::ParameterSet&);
      ~SusyDESY_TobTecFakesProducer();
...
//
SusyDESY_TobTecFakesProducer::SusyDESY_TobTecFakesProducer(const edm::ParameterSet& iConfig):
  ...
  m_absJetCut(iConfig.getParameter<double>("absJetCut"))
{
  ...
  produces <int>   ( "TobTecFakesFilterFlag");
  produces <float> ( "TobTecFakesFilterRatioAll" );
  produces <float> ( "TobTecFakesFilterRatioJet" );
  produces <float> ( "TobTecFakesFilterAbsJet" );

}

SusyDESY_TobTecFakesProducer::~SusyDESY_TobTecFakesProducer()
{
...
void
SusyDESY_TobTecFakesProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
//	      << " and " << n_iterTobTecTrks << " / " << n_iterPixelTrks << std::endl;
  ...
  auto_ptr<int> flag( new int(selected) );
  auto_ptr<float> ratioAll( new float(ritertobtec) );
  auto_ptr<float> ratioJet( new float(ritertobtecjet) );
  auto_ptr<float> absJet( new float(n_iterTobTecTrksInIterTobTecJet) );

  iEvent.put( flag, "TobTecFakesFilterFlag");
  iEvent.put( ratioAll, "TobTecFakesFilterRatioAll");
  iEvent.put( ratioJet, "TobTecFakesFilterRatioJet");
  iEvent.put( absJet, "TobTecFakesFilterAbsJet");

}

// ------------ method called once each job just before starting event loop  ------------
void 
SusyDESY_TobTecFakesProducer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
SusyDESY_TobTecFakesProducer::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(SusyDESY_TobTecFakesProducer);
