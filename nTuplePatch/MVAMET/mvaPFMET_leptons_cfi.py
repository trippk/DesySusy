...
isotaus = cms.EDFilter(
    ...
    cms.PSet( discriminator=cms.InputTag("hpsPFTauDiscriminationByDecayModeFindingMVAMET"), selectionCut=cms.double(0.5)),
...
isotauseq      = cms.Sequence(
     hpsPFTauDiscriminationByDecayModeFindingMVAMET*
