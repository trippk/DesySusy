...
class defaultTree: public subTree {
 public:
  ...
  void Fill(EventInfo* info, EasyChain* tree, vector<Muon*>& muons_in, vector<Electron*>& electrons_in, vector<Ptr_Jet>& jets_in, vector<Ptr_GenJet>& genjets_in, LorentzM& met_in);
  //
  virtual void Write();
